...
public class Category2 {
    ...
    Category2(String textField1) {
        ...
        b4 = new JButton();
        b4.setIcon(new ImageIcon("image/Samocha.png"));
        b4.setBounds(60, 160, 300, 220);
        b4.setCursor(new Cursor(Cursor.HAND_CURSOR));
        b4.setBackground(Color.white);
        // b4.setContentAreaFilled(false);
        // b4.setBorderPainted(false);
        l1 = new JButton("Samocha");
        ...
        b5 = new JButton();
        b5.setIcon(new ImageIcon("image/BeefSamocha.jpeg"));
        b5.setBounds(380, 160, 300, 220);
        b5.setCursor(new Cursor(Cursor.HAND_CURSOR));
        b5.setBackground(Color.white);
        // b5.setContentAreaFilled(false);
        // b5.setBorderPainted(false);
        l2 = new JButton("Beef Samocha");
